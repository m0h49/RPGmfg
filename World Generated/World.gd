...
var taken_walks = []
var big_borders = Rect2(1, 1, 38, 21) #Rect2(1, 1, 38, 21)
var small_borders = Rect2(1, 1, 44, 35)
...
func generate_level():
	...
	var walker_small = Walker.new(Vector2(32, 32), small_borders)
	var map_small = walker_small.walk(300)
	...
	for location in map_small:
		dirtPathTileMap.set_cellv(location, 0)
	dirtPathTileMap.update_bitmask_region(small_borders.position, small_borders.end)
